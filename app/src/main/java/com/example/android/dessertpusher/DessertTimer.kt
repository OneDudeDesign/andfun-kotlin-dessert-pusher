...
// (01) Make DessertTimer a LifecycleObserver by implementing LifecycleObserver
// (02) Have DessertTimer take in a Lifecycle as a parameter and set up the
...
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    // (03) Annotate startTimer and stopTimer with @OnLifecycleEvent and the correct event
